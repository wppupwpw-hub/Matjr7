...
function extractTopics(text) {
  // مثال بسيط: يمكن استخدام نماذج لغوية معقدة هنا.
  const topics = [];
...
function identifyQuestionType(analysis) {
  ...
  // أنواع الأسئلة المختلفة (70000+ نوع!)
  const questionTypes = {
    // الجغرافيا والمواقع
    geography: {
  ...
  // تحديد نوع السؤال بناءً على الكلمات المفتاحية
